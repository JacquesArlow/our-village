...
<template>
  <section class="container-px section-y">
    ...
    <div v-for="g in groups" :key="g.key" class="mb-10">
      ...
      <ul class="space-y-3">
        <li v-for="e in g.events" :key="e.id" class="flex items-stretch gap-4 rounded-box border border-base-200 bg-base-100 p-3 transition hover:border-primary/40 hover:shadow-sm">
